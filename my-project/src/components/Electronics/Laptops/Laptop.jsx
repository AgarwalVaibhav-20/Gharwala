...
function Laptop() {
  const data=[
    {
      image:
        "https://m.media-amazon.com/images/I/510uTHyDqGL._SY450_.jpg",
      name: "Laptop",
      company:
        "Microsoft New Surface Laptop (7th Edition) - Windows 11 Home Copilot + PC - 13.8” LCD PixelSense Touchscreen - Qualcomm Snapdragon X Elite (12 Core) - 16GB RAM - 512GB SSD - Graphite - ZGP-00059",
      rate: "₹1,50,990.00",
    },
    {
      image:
      ...
      name: "Laptop",
      company:
       "Microsoft Surface Laptop GO 3 Touch Screen 12.4 Inch, i5 /12th Gen Intel Core i5 1235U /8GB RAM /256GB SSD/Windows 11 /English Hdwr Platinum - XK1-00045",
      rate: "₹79,990.00",
    },
    {
      image:
    ...
    },
    {
      ...
      name: "Laptop",
      company:
        "HP Victus 39.6 cm (15.6) Gaming Laptop 15-fa1413TX, Blue",
      rate: "₹73,678.00",
    },
    {
      image:
        "https://cdn1.smartprix.com/rx-iTbXqVtL1-w420-h420/hp-b12v5pt-laptop-13.webp",
      name: "Laptop",
      company:
        "HP B12V5PT Laptop (13th Gen Core i3/ 16GB/ 512GB SSD/ Win11)",
      rate: "₹34,390.00",
    },
    {
      image:
   ...
   return (
     <div className="relative w-full max-w-full mx-auto p-4">
      <h1 className="text-5xl mt-5 mb-5 max-sm:text-2xl font-light "><Link to="">Laptops</Link></h1>
       <div
         id="card-container1"
